...
| 3 | **The AI-provider pricing policy does not break the model** | **unresolved — now the first economic risk** | Meta's pricing page links a *"New pricing policy for AI Providers leveraging WhatsApp Business Platform"*, effective 2026-02-16, updated 2026-05-12. This product is an AI provider on WhatsApp. Terms unread — the page is blocked here. [Meta AI-provider pricing](https://developers.facebook.com/documentation/business-messaging/whatsapp/pricing/ai-providers) | none — read the policy |
...
## Open questions
- [ ] [NEEDS CLARIFICATION: what does Meta's AI-provider pricing policy (eff. 2026-02-16, upd. 2026-05-12) charge, and does it apply to this product?]
